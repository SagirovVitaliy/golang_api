...
func (r *ListPostgres) Create(userID int, list rest.List) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *ListPostgres) GetAll(userID int) ([]rest.List, error) {
	var lists []rest.List
...
func (r *ListPostgres) GetById(userID, listID int) (rest.List, error) {
	var list rest.List
...
func (r *ListPostgres) Update(userId, listId int, input .UpdateListInput) error {
